...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    _readGlobal();
    _widget[0] = MyMap(
        rangeValue: _Rangevalue, tableauCarburant: _tableauCarburantChecked);
        ...
        appBar: AppBar(
            ...
            title: Row(
              ...
              children: [
                ...
                Image.asset("assets/images/TuCarburesBanner.png",
                ...
                Visibility(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(
                            context, StationCreation.routeNames);
                      },
                    )),
              ],
            )),
                    ...
                    if (snapshot.connectionState == ConnectionState.done &&
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          _tableauCarburantChecked.putIfAbsent(
                              code, () => false);
